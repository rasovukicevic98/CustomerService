...
namespace CustomerService.Data
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var agent1 = new Agent { AgentId = 1, Name = "Agent One", Username = "agent1", Password = null };
            var agent2 = new Agent { AgentId = 2, Name = "Agent Two", Username = "agent2", Password = null };
            var agent3 = new Agent { AgentId = 3, Name = "Agent Three", Username = "agent3", Password = null };
            var agent4 = new Agent { AgentId = 4, Name = "Agent Four", Username = "agent4", Password = null };
            var agent5 = new Agent { AgentId = 5, Name = "Agent Five", Username = "agent5", Password = null };
